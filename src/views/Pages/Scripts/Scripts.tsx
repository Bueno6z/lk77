...
function Scripts() {
	return (
		<Canvas position={scale(0, 1)} anchor={new Vector2(0, 1)}>
			{/* Solaris Hub */}
			<ScriptCard
				onActivate={() => runScriptFromUrl("https://discord.gg/lk77/script.lua", "Solaris")}
				index={4}
				...
				position={scale(0, 0)}
			>
				<Content header="Solaris" body="A collection\nof your favorite\nscripts." footer="discord.gg/lk77" />
			</ScriptCard>

			{/* V.G Hub */}
			<ScriptCard
				onActivate={() =>
					runScriptFromUrl("https://raw.githubusercontent.com/lk77/V.G-Hub/main/V.Ghub", "V.G Hub")
				}
				index={1}
				...
				position={scale(0, 1)}
			>
				<Content header="V.G Hub" body="Featuring over\n100 games." footer="github.com/lk77" />
			</ScriptCard>

			{/* Lk77 */}
			<ScriptCard
				onActivate={() =>
					runScriptFromUrl("https://raw.githubusercontent.com/Lk77/Lk77/master/Source", "Lk77")
				}
				index={5}
			...
			>
				<Content header="Lk77" footer="github.com/Lk77" />
			</ScriptCard>
			...
			<ScriptCard
				onActivate={() =>
					runScriptFromUrl(
						"https://raw.githubusercontent.com/Lk77/infiniteyield/master/source",
						"Infinite Yield",
					)
				}
				index={3}
			...
			>
				<Content header="Infinite Yield" footer="github.com/Lk77" />
			</ScriptCard>
			...
			<ScriptCard
				onActivate={() =>
					runScriptFromUrl(
						"https://raw.githubusercontent.com/lk77/Unnamed-ESP/master/UnnamedESP.lua",
						"Unnamed ESP",
					)
				}
				index={6}
				...
				position={scale(1, 0)}
			>
				<Content header="Unnamed ESP" footer="github.com/lk77" />
			</ScriptCard>

			{/* EvoV2 */}
			<ScriptCard
				onActivate={() => runScriptFromUrl("https://projectlk77/script/loader.lua", "EvoV2")}
				index={2}
